...
describe("valuation workspace API contract", () => {
  ...
  test("persists sanitized restored preset source metadata in saved drafts", () => {
    const draft: QuantitativeDraft = {
      method: "dcf_3_statement", archetype: "operating", currency: "CNY", asOf: "2026-06-21",
      assumptions: [{ key: "revenueGrowth", label: "收入增速", bear: 3, base: 7, bull: 11, unit: "%", origin: "formula", locked: false }],
      operating: {
    ...
    expect(merged.restoredPresetLibrary).toEqual({
      version: 4,
      restoredAt: "2026-06-26T00:20:00.000Z",
    });
  });

  test("drops invalid restored preset source metadata while saving drafts", () => {
    const draft: QuantitativeDraft = {
      method: "dcf_3_statement", archetype: "operating", currency: "CNY", asOf: "2026-06-21",
      assumptions: [{ key: "revenueGrowth", label: "收入增速", bear: 3, base: 7, bull: 11, unit: "%", origin: "formula", locked: false }],
    };
    ...
    expect(merged.restoredPresetLibrary).toBeUndefined();
  });
});
