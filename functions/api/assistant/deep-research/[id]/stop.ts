import { requestAssistantDeepResearchStop } from "../../../../_shared/assistant-deep-research";
...
export const onRequestPost: PagesFunction<AssistantEnv> = async ({ request, env, params }) => {
  ...
  const job = await requestAssistantDeepResearchStop(env.REPORT_LIBRARY_DB, session.userId, id);
